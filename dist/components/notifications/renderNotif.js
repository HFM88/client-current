document.addEventListener("DOMContentLoaded", async function () {
    ...
    function renderNotification(notification) {
        ...
        elementId++;
        return `
            <div id=${"notif" + elementId} class="flex flex-col sm:flex-row space-y-2 justify-between items-start md:items-center border-b border-b-text border-opacity-20 pb-4">
                <div class="flex items-center justify-between xs:justify-normal flex-wrap space-x-2 px-4">
                    <a class="py-2 flex justify-center items-center" href="/profile" id="user-profile">
                        <div class="w-12 h-12 overflow-hidden rounded-full">
                            <img src="${'http://localhost:5000/cdn/' + profilepic || 'https://via.placeholder.com/150'}" alt=""
